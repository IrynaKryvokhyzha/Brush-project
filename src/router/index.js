...
const routes = [
 ...
 },
 {
	...
	component: () =>
  import(/* webpackChunkName: "individual-brushes" */ "../components/My Shop/IndividualBrushes/BrushesList"),
},
{
	...
	component: () =>
  import(/* webpackChunkName: "pro-create-set" */ "../components/My Shop/ProCreateSet/ProCreateSetList"),
},
{
	...
	component: () =>
  import(/* webpackChunkName: "travel-kit" */ "../components/My Shop/TravelKit/TravelKitList"),
},
 {
	...
	component: () =>
	  import(/* webpackChunkName: "brush-editor" */ "@/components/My Shop/IndividualBrushes/BrushEditor.vue"),
	// props: true,
 }, 
 {
	...
	component: () =>
	  import(/* webpackChunkName: "proCreateSet-editor" */ "@/components/My Shop/ProCreateSet/ProCreateSetEditor.vue"),
	  props: true,
	...
	}, 
 {
	...
	component: () =>
  import(/* webpackChunkName: "travelKit-edito" */ "@/components/My Shop/TravelKit/TravelKitEditor"),
  props: true,
},
 {
	path: "/cart/:productId?",
 ...
 }, 
 {
	...
	component: () =>
	  import(/* webpackChunkName: "brush-precautions" */ "@/components/BrushPrecautions.vue"),
 }, 
 {
	path: "/return-policy",
	name: "return-policy",
